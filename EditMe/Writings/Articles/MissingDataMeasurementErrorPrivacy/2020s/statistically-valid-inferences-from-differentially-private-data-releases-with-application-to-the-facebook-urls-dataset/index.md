...
abstract: |-
  ...
  We have implemented these methods in open source software for R called [PrivacyUnbiased](https://github.com/georgieevans/PrivacyUnbiased). Facebook has ported PrivacyUnbiased to open source Python code called [svinfer](https://github.com/facebookresearch/svinfer/). We have extended these results in [Evans and King (2021)](/publication/statistically-valid-inferences-from-differentially-private-data-releases-ii-extensions-to-nonlinear-transformations/).

  Replication data at the Harvard Dataverse: [https://doi.org/10.7910/DVN/UDFZJD](https://doi.org/10.7910/DVN/UDFZJD).
links:
  - type: pdf
